...
public class CentralHVACCommandsDB {

	private Database myDatabase;
	private SQLiteDatabase sqLiteDatabase;

	public CentralHVACCommandsDB(Context context) {
		// TODO Auto-generated constructor stub
		myDatabase = new Database(context);

	}

	public ArrayList<CommandParameters> getAllCentralHVACCommands() {
		ArrayList<CommandParameters> Arr = null;
		sqLiteDatabase = myDatabase.OpenDatabase();
		Cursor c = sqLiteDatabase.query("CentralHVACCommands", null, null,
	...
	public ArrayList<CommandParameters> getCentralHVACCommandsWithFloor(int floorID) {
		ArrayList<CommandParameters> Arr = null;
		sqLiteDatabase = myDatabase.OpenDatabase();
		Cursor c = sqLiteDatabase.query("CentralHVACCommands", null, "FloorID="+floorID,
				null, null, null, "SequenceNo");
		if (c.getCount() > 0) {
			Arr = new ArrayList<CommandParameters>();
			c.moveToFirst();
