...
public interface CONST{
	public static final String CONST_BUIlD_DATE="(build on Feb 07,2012)";
	...
	public static final String CONST_TITLE_OFFICIAL_REGISTERED_VERSION= "(Official PRO version,Registered)";
	...
	//string define
	public static final String CONST_STR_UNKNOWN="Unknow";
