...
package com.roka.smarthomeg4.color_picker;
...
public class ColorPickerView extends View {
	 ...
	 * color panels.
	 */
	private float 		PANEL_SPACING = 5f;
	/**
	 * The radius in dp of the color palette tracker circle.
	 */
	private float 		PALETTE_CIRCLE_TRACKER_RADIUS = 10f;
	/**
	...
	private void initPaintTools(){
		...
		mSatValTrackerPaint.setStrokeWidth(5f * mDensity);
		mSatValTrackerPaint.setAntiAlias(true);

		mHueTrackerPaint.setColor(mSliderTrackerColor);
		mHueTrackerPaint.setStyle(Style.STROKE);
		mHueTrackerPaint.setStrokeWidth(4f * mDensity);
